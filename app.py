...
POLIKLINIKLER = {
    ...
    "Heyet Psikolog": {
        "fancy": False, "kat": "1kat",
        "tarif": "Ana girişten girdikten sonra sola dönün. Ön merdivenleri çıkınca sola dönün. Sol tarafınızdaki küçük koridorun ilerisinde sol tarafta veya arka merdivenlerden çıkınca sola dönün koridorun solunda yer alır.",
...
DIGER_ALANLAR = {
    "Evrak Kayıt / Vezne": {
        "fancy": False, "kat": "zemin", 
        "tarif": "Zemin Kat - Ana girişte tam karşınızda.", 
...
with col_mic:
    ...
    <script>
        const tarifVeritabani = {
            ...
            "sağlık kurulu kayıt birimi": "Zemin Kat - Ana girişten hemen sonra sola dönün. Sol taraftaki etrafı kapalı yerdir.",
            "ön merdivenler": "Zemin Kat - Ana girişten girdikten sonra sola dönün, koridorun sonuna doğru sol tarafta yer alır.",
            ...
            "heyet göğüs hastalıkları poliklinik": "Birinci Kat - Merdivenlerden çıkınca karşınızda, asansörden çıktıysanız sola dönün. Nöroloji polikliniğin yanında yer alır.",
            "heyet göz poliklinik": "Birinci Kat - Merdivenlerden veya asansörden çıkınca sola dönün. Koridorun sonunda sağ tarafta, Göz Ölçüm odasının yanında yer alır.",
            ...
            "heyet üroloji poliklinik": "Birinci Kat - Merdivenlerden veya asansörden çıkınca sola dönün. Koridorun sonunda sol tarafta, Heyet Göz polikliniğin karşısında yer alır",
            ...
            "göz ölçüm": "Birinci Kat - Merdivenlerden veya asansörden çıkınca sola dönün. Koridorun sağ tarafında, Heyet Göz polikliniğin yanında yer alır.",
            "nöroloji poliklinik 1": "Birinci Kat - Merdivenlerden çıkınca sağa, asansörden çıkınca sola dönün. Heyet Genel Cerrahi polikliniğin yanında yer alır.",
            "heyet psikiyatri poliklinikleri": "Birinci Kat - Merdivenlerden çıkınca sağa dönün ileride solda, asansörden çıkınca tam karşınızda yer alır.",
